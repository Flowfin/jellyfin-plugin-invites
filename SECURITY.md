...
Jellyfin.Plugin.Invites/Controllers/RedeemController.cs:332:        if (!_ceiling.MayCreate())
```
...
docs/setup-never-asks.md:123:It does not say which server it belongs to, which the presentation rules above
```
