...
Status: neither part exists. issue 107 stands where the row above leaves it, and no manual check has been recorded.

Status: the formatter runs on every pull request. issue 19 stands where the row above leaves it and the row above
is what it replaced.

Status: the landing that carried it is in the mainline. issue 354 stands where the row above leaves it, which the
