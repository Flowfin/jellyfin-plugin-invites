...
/// </para>
/// <para>
/// <b>It carries no record and no field of one.</b> A count and two version
...
public sealed class StoreMigration
{
    ...
    /// </param>
    public StoreMigration(int from, int to, int recordsWithoutAGrant)
    {
        From = from;
        To = to;
