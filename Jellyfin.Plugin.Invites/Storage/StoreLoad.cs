...
public sealed class StoreLoad : IDisposable
{
    ...
    /// where the claim was refused and no read was made.
    /// </summary>
    ...
    /// caller's decision, for the reason argued on <see cref="ConsistencyReport"/>.
    /// </param>
    /// <returns>
    /// The load. Release the claim by disposing it, which is what the caller
    /// does when the server is stopping.
    /// </returns>
    /// <exception cref="ArgumentNullException">The clock or the account list is null.</exception>
